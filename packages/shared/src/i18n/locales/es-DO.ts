...
export const es = {
  ...
  onboarding: {
    ...
    photosSub: 'Entre 2 y 6 fotos. Cada una pasa por moderación antes de publicarse.',
    photoTipsTitle: 'Las fotos que funcionan',
    photoTips: [
      'Con luz natural y el rostro bien visible: sin lentes oscuros ni gorra.',
      'Tú, no un grupo: la primera foto debe dejar claro quién eres.',
      'Reciente y sin filtros: la persona que te conozca debe reconocerte.',
      'Una haciendo algo que amas (servir, cantar, caminar) cuenta más que una pose.',
    ],
    photoModerationEta:
      'Una persona del equipo la revisa antes de publicarla: normalmente en menos de 24 horas; los fines de semana puede tardar un poco más. Te avisamos cuando esté lista.',
    photoRejectedHint: 'No cumple el Pacto de conducta o no se te ve bien. Puedes subir otra.',
    photoUploadAnother: 'Subir otra',
    ...
    doneSub: 'Tu cuenta está creada. Lo demás lo completas cuando quieras, a tu ritmo.',
    essentialsTitle: 'Lo esencial',
    essentialsSub: 'Cuatro cosas y entras. El resto de tu perfil lo completas cuando quieras.',
    displayName: 'Tu nombre, como quieres que te vean',
    cityLabel: 'Ciudad donde vives',
    cityOther: 'Otra ciudad',
    denominationOptional: 'Denominación (opcional, la puedes añadir después)',
    reachWithNumber: (n: number) =>
      `Ya hay más de ${n} personas de tu denominación con perfil completo en Yugo.`,
    reachWithout: 'Ya hay personas de tu denominación con perfil completo en Yugo.',
    reachFirst: 'Serás de las primeras personas de tu denominación en Yugo: tu perfil abre camino.',
    nextStepsTitle: 'Lo que más ayuda ahora',
    nextPhotos: 'Sube dos fotos',
    nextPhotosHint: 'Sin fotos aprobadas tu perfil no aparece en Descubrir.',
    nextVerify: 'Verifica tu identidad',
    nextVerifyHint: 'Una selfie de un minuto. Los perfiles verificados reciben más respuestas.',
    nextComplete: 'Cuenta un poco más de ti',
    nextCompleteHint: 'Tu iglesia, tu testimonio, tus prácticas: alimentan la afinidad de fe.',
    goHome: 'Ir a Inicio',
  },
  ...
  community: {
    ...
    myGroupsEmpty: 'Todavía no estás en ningún grupo. Mira los sugeridos: hay uno cerca de ti.',
  ...
  events: {
    ...
    share: 'Compartir',
    shareCopied: 'Enlace copiado. Pégalo donde quieras invitar.',
    notFound: 'Este encuentro ya no está disponible.',
  ...
  profile: {
    ...
    verificationChurchDone: (church: string) => `Respaldado por ${church}`,
    verificationContactPending: 'Confirma tu correo o teléfono',
    verificationIdentityStart: 'Verificar mi identidad',
    verificationIdentityRejected: 'La selfie no se aprobó. Puedes intentarlo de nuevo.',
    pausedHint: 'Mientras esté pausado no apareces en Descubrir; tus conexiones siguen.',
    savedPreferences: 'Preferencias guardadas',
    editTitle: 'Completa tu perfil',
    editSub: 'Todo es opcional. Cada dato que añades mejora tu afinidad de fe con otras personas.',
    editSaved: 'Perfil guardado',
    editBasics: 'Lo básico',
    ...
    fields: {
      ...
      photos: 'dos fotos aprobadas',
      denomination: 'tu denominación',
      church: 'tu iglesia',
      yearsInFaith: 'tus años en la fe',
      attendance: 'con qué frecuencia asistes',
      intention: 'qué buscas en Yugo',
      openness: 'tu apertura a otras denominaciones',
  ...
  visibility: {
    ...
    whoViewedOroOnly: 'Con Oro',
    travelPick: 'Ciudad donde vas a estar',
    travelActive: (city: string, date: string) => `${city} · hasta el ${date}`,
    travelOff: 'Sin destino configurado',
    travelDays: (days: number) => `${days} días`,
    oroOnlyHint: 'Disponible con Yugo Oro.',
  ...
  admin: {
    ...
    kpiNewMembers: 'Nuevos registros (30 d)',
    nothingPending: 'Nada pendiente ahora mismo.',
  ...
  church: {
    ...
    noUpcoming: 'No hay eventos próximos. Crea el primero con «+ Nuevo evento».',
  ...
  explore: {
    ...
    title: 'Así es Yugo por dentro',
    sub: 'Puedes mirar sin registrarte: el devocional que hoy comparten miles de personas, los encuentros que las iglesias están convocando y las historias que ya pasaron aquí. Los perfiles, las conexiones y el muro de oración se abren cuando creas el tuyo.',
    enter: 'Entrar',
    ...
    exampleLine: 'Denominación · Iglesia · Ciudad · Propósito',
    exampleWhy: 'Se te explica por qué: comparten denominación, práctica de servicio y cercanía.',
    stories: 'Historias que ya pasaron aquí',
  ...
  gate: {
    ...
    churchOnlyBody:
      'Tu cuenta no está vinculada a ninguna iglesia. Si eres líder o encargado, registra tu congregación: el equipo de Yugo la revisa y, aprobada, podrás publicar eventos, respaldar miembros y ver tus métricas.',
    registerChurch: 'Registrar mi iglesia',
    churchName: 'Nombre de la iglesia',
    churchCity: 'Ciudad',
    churchAddress: 'Dirección',
    contactName: 'Persona de contacto',
    contactEmail: 'Correo de contacto',
    registerSent: 'Recibimos el registro. Te avisaremos cuando esté aprobada.',
    churchPendingTitle: 'Tu iglesia está en revisión',
    churchPendingBody: (name: string) =>
      `${name} ya está registrada. El equipo de Yugo la revisa antes de habilitar el portal completo; mientras tanto puedes preparar tus eventos como borradores.`,
    churchRejectedTitle: 'El registro no fue aprobado',
    churchRejectedBody: 'Escríbenos para revisar el caso.',
  },
  notFound: {
