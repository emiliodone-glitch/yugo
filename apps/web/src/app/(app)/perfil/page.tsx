...
import { useLogout, useMyPhotos, useSubscriptionState, useVerificationStatus } from '@/lib/hooks';
      ...
      <div>
        ...
        <div className="card mt-3.5">
          ...
          <div className="mt-1.5 text-[11px] text-muted">
            {es.profile.completenessHint(
              user.completenessNext.field,
              user.completenessNext.targetPct,
            )}
          </div>
        </div>
